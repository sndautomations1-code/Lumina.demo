...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'about.p1': 'Founded in 2018, Lumina Aesthetics was born from a singular vision — to create a sanctuary where medical precision meets artistic sensibility. Nestled in the heart of Bucharest, our clinic has become the destination for those who understand that true beauty lies in refinement, not excess.',
    ...
    'contact.info.address': 'Bucharest, Sector 1',
    'contact.info.address2': 'Calea Victoriei 120',
    'contact.info.phone': '+40 731 234 567',
    'contact.info.email': 'hello@luminaaesthetics.ro',
    'contact.info.hours': 'Working Hours',
    'contact.info.hours.weekdays': 'Mon – Fri: 9:00 – 19:00',
  ...
  ro: {
    ...
    'about.p1': 'Fondată în 2018, Lumina Aesthetics s-a născut dintr-o viziune singulară — de a crea un sanctuar unde precizia medicală întâlnește sensibilitatea artistică. Situată în inima Bucureștiului, clinica noastră a devenit destinația pentru cei care înțeleg că adevărata frumusețe stă în rafinament, nu în exces.',
    ...
    'contact.info.address': 'București, Sector 1',
    'contact.info.address2': 'Calea Victoriei 120',
    'contact.info.phone': '+40 731 234 567',
    'contact.info.email': 'hello@luminaaesthetics.ro',
